...
<?php Pjax::begin([
    'id' => 'adminIndex',//#adminIndex a:not(#adminIndex #adminUpdate a),#adminIndex input:not(#adminUpdate input),#adminIndex button:not(#adminUpdate button)
    'linkSelector' => '#adminIndex button:not(#adminUpdate button)',
    'formSelector' => '#adminIndex form[data-pjax]:not(#adminUpdate form[data-pjax], #adminCreate form[data-pjax])',
    'clientOptions' => [
